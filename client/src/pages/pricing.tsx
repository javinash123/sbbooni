...
const plans = [
  ...
  { name: "Integrated", price: "Custom", setup: "Contact us", features: [] },
  { name: "Custom", price: "Enterprise", setup: "Scalable", features: [] }
];
            ...
            {plans.map((p) => (
              <button 
                ...
                className={cn(
                  ...
                  p.name === "All-in-One" ? "bg-primary text-white" : "bg-white/5 text-white/50 hover:bg-white/10"
                )}
              >
                {p.name}
              </button>
          ...
          <div className="grid lg:grid-cols-[1fr_2fr] gap-8">
            ...
            >
              <div className="text-center mb-8">
                <p className="text-[10px] font-black uppercase tracking-widest text-gray-400 mb-2">Best for Starter and Power</p>
                <h2 className="text-7xl font-black mb-2">Free</h2>
                <p className="text-xs text-gray-400">{plans[0].setup}</p>
              </div>
              ...
              <button className="mt-8 text-primary font-bold text-sm hover:underline text-left">View all features</button>
            </motion.div>
            ...
            >
               ...
               <h3 className="text-3xl font-black mb-6">{plans[0].mainFeature?.title}</h3>
               <p className="text-white/60 text-lg mb-10 max-w-xl">{plans[0].mainFeature?.desc}</p>

               <div className="grid sm:grid-cols-2 gap-8 mb-12">
                  {plans[0].mainFeature?.stats.map((s: any, i: number) => (
               ...
               <div className="pt-10 border-t border-white/10">
                  ...
                  <div className="flex flex-wrap gap-4">
                     <Button className="bg-white text-black hover:bg-white/90 rounded-xl px-8 h-14 font-black">Download App</Button>
                     <Button variant="outline" className="border-white/20 text-white rounded-xl px-8 h-14 font-black">Request Demo</Button>
                  </div>
               </div>
            </motion.div>
          </div>
